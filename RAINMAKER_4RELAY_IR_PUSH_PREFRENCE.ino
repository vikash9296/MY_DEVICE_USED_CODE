/**********************************************************************************
 * TITLE: ESP RainMaker + IR + Manual Button control 4 Relays using ESP32 (store last GPIO state + Real time feedback + no WiFi control)
...
const char *service_name = "PROV_1234RB4"; // 4-चैनल के लिए बदला गया
const char *pop = "12345RB4"; // 4-चैनल के लिए बदला गया

// define the Chip Id
uint32_t espChipId = 0;

// define the Node Name
char nodeName[] = "VIKASH_Relay_4B"; // 4-चैनल के लिए बदला गया
...
#define IR_Button_1   0xFF2AD5
#define IR_Button_2   0xFF6897
#define IR_Button_3   0xFFA857
#define IR_Button_4   0xFF0AF5
#define IR_All_Off    0xFF38C7
#define IR_All_On     0xFF10EF
...
void all_SwitchOff(){
  ...
  pref.putBool("Relay2", toggleState_2); my_switch2.updateAndReportParam(ESP_RMAKER_DEF_POWER_NAME, toggleState_2); delay(100);
  ...
  pref.putBool("Relay4", toggleState_4); my_switch4.updateAndReportParam(ESP_RMAKER_DEF_POWER_NAME, toggleState_4); delay(100);
}
